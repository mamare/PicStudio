...
export const RotateCwIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.042 21.672 13.684 16.6m0 0-2.51 2.225.569-9.47 5.227 7.917-3.286-.672ZM12 2.25V4.5m5.834.166-1.591 1.591M21.75 12h-2.25m.166 5.834-1.591-1.591M5.834 5.834 4.242 4.242M4.5 12H2.25m3.334 5.834 1.591-1.591M12 19.5v2.25" />
  </svg>
);

export const RotateCcwIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.958 21.672a8.962 8.962 0 0 1-7.158-4.025m11.218 4.025a8.962 8.962 0 0 1-8.38-5.082M21.75 12H12m9.75 0a8.963 8.963 0 0 1-4.025 7.158m4.025-7.158a8.963 8.963 0 0 0-4.025-7.158m0 0a8.963 8.963 0 0 0-7.158-4.025m7.158 4.025 2.51 2.225-5.69 9.47-5.227-7.917 3.286.672Z" />
  </svg>
);

export const StarsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
